...
func (r *RulesfileReconciler) Reconcile(ctx context.Context, req ctrl.Request) (_ ctrl.Result, reterr error) {
	...
	// In enforce mode, defer reconciliation until the instance operator has processed the current
	// spec generation, gating reference resolution, compatibility checks, and filesystem changes.
