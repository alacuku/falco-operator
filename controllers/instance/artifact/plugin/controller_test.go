...
func withPluginSelector(key, value string) func(*artifactv1alpha1.Plugin) {
	return func(p *artifactv1alpha1.Plugin) {
		p.Spec.Selector = &metav1.LabelSelector{MatchLabels: map[string]string{key: value}}
	}
}
...
func TestReconcile_DeletesStaleNodeObject(t *testing.T) {
	plugin := newTestPlugin(withPluginSelector("env", "prod"))
