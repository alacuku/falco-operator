...
// its content — via the same atomic rename-based write Store already uses for every other
// update, which Falco does reliably pick up — avoids that class of missed reload entirely.
//
