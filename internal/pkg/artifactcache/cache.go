...
// HTTP server (reader) — both running as goroutines in the same process.
//
...
// Example: "ghcr.io/falcosecurity/plugins/cloudtrail:0.12.0" → "ghcr.io-falcosecurity-plugins-cloudtrail-0.12.0".
