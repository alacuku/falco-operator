...
// longer remove its own finalizer from the per-node object (ConfigNode, PluginNode,
// RulesfileNode). Without this call the node objects would remain stuck in Terminating
// indefinitely, blocking parent artifact cleanup.
